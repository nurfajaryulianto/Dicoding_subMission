...
all_df = pd.read_csv("https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_subMission/main/Dicoding%20Submission_Data%20Science/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_subMission/main/Dicoding%20Submission_Data%20Science/dashboard/geolocation.csv')
...
st.caption('Copyright (C) Nur Fajar Yulianto')
